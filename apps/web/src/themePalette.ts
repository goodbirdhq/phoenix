...
/** The default appearance palette mirrors index.css so theme drafts start from the visible app. */
const T3_CODE_LIGHT_THEME_COLORS: ThemeColors = {
  ...
  update: "#0284c7",
  updateForeground: "#0369a1",
  updateSurface: "#e0f2fe",
...
const T3_CODE_DARK_THEME_COLORS: ThemeColors = {
  ...
  warningSurface: "#32291b",
  update: "#38bdf8",
  updateForeground: "#38bdf8",
  updateSurface: "#172c38",
  accentSurface: "#27272a",
  accentSurfaceForeground: "#f4f4f5",
  messageSurface: "#27272a",
  messageForeground: "#f4f4f5",
  messageAction: "#027cbd",
  messageActionForeground: "#ffffff",
  messageActionHover: "#0369a1",
  ...
  sidebarControlSurface: "#27272a",
  sidebarRowHover: "#27272a",
  sidebarRowActive: "#27272a",
  sidebarRowSelected: "#27272a",
...
/**
 * The standard Phoenix look as a theme palette, for seeding a new theme when
...
/**
 * The status colors Phoenix shows without a theme, read from the app's own
