...
const T3_CHAT_LIGHT_COLORS: ThemeColors = {
  canvas: "#fdf7fd",
  // Phoenix's workspace header belongs to the chat panel, so keep it seamless
  ...
  // dark plum pair here also leaked the dark palette into Phoenix's diffs.
...
const T3_CHAT_DARK_COLORS: ThemeColors = {
  ...
  // Diffs and file previews are full workspace surfaces in Phoenix. Keep them
