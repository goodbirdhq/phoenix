...
export function deriveWorkLogEntries(
  ...
  for (const activity of ordered) {
    // Child report state belongs exclusively to the durable digest. Rendering
    // it here as a timeline row would keep superseded report updates visible.
    if (activity.kind === "session-report.posted") continue;
