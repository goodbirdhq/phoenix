...
export function ThreadPullRequestBadgeControl({
  ...
  // A count represents more than one link, so it must open this thread's picker rather than
  // silently choosing one of its links. The picker is scoped by the caller's thread ref.
  const opensPicker = isStack || linkedCount !== null;
