...
function getGnomeKeyringRemediationMessage(): string {
  return "Phoenix could not access GNOME Keyring to save this environment credential. Install and start GNOME Keyring, then restart Phoenix.";
}

function getKWalletRemediationMessage(): string {
  return "Phoenix could not access KWallet to save this environment credential. Enable the KDE wallet subsystem in System Settings, then restart Phoenix.";
}
