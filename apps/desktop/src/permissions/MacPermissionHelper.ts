...
<header>↑ Drag Phoenix into the list above</header>
<button id="app" draggable="true" aria-label="Drag Phoenix to System Settings, or click to reveal in Finder"><img src="${escapeHtml(icon)}" alt="" draggable="false">Phoenix</button>
</main></body></html>`;
}
...
export class MacPermissionHelper {
  ...
  async show(
    ...
    if (!appIcon) throw new Error("The packaged Phoenix icon is missing.");
