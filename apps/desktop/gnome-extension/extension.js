...
const NAME = "org.gnome.Shell.Extensions.PhoenixSnapShot";
const PATH = "/org/gnome/Shell/Extensions/PhoenixSnapShot";
...
function takeSnapshot(animate) {
  ...
  if (animate && St.Settings.get().enable_animations) {
    try {
      ...
      console.warn(`Phoenix capture preview unavailable: ${error.message}`);
    }
  }
...
export default class PhoenixSnapShotExtension extends Extension {
  enable() {
