...
/** Only an in-place Active reorder is an explicit choice of Manual ordering. */
export function shouldUseManualOrderingAfterMove(
  source: ThreadDragSection,
  destination: ThreadDragSection,
): boolean {
  return source === "active" && destination === "active";
}
