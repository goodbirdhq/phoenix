...
// Use the full-bleed Phoenix artwork; Android supplies the launcher mask.
...
if (
  ...
  throw new Error(
    "T3CODE_IOS_PERSONAL_TEAM_BUNDLE_ID must be a reverse-DNS identifier such as com.example.phoenix when T3CODE_IOS_PERSONAL_TEAM=1.",
  );
}
...
const DEVELOPMENT_ASSETS = {
  ...
  androidAdaptiveForeground: fromRepoRoot(BRAND_ASSET_PATHS.developmentIosIconPng),
    ...
    widgets: [
      {
        ...
        description: "Shows the current state of active Phoenix agents.",
...
const config: ExpoConfig = {
  ...
  updates: {
    ...
    url: "https://u.expo.dev/5844a805-9eb9-470e-b5be-d2b435546ebd",
  ...
  ios: {
    ...
    infoPlist: {
      ...
      NSLocalNetworkUsageDescription:
        "Allow Phoenix to connect to Phoenix servers on your local network or tailnet.",
      NSPhotoLibraryAddUsageDescription: "Allow Phoenix to save images to your photo library.",
  ...
  plugins: [
    ...
    [
      "expo-audio",
      {
        microphonePermission: "Allow Phoenix to use your microphone for voice input.",
    ...
    [
      "expo-camera",
      {
        cameraPermission: "Allow Phoenix to access your camera so you can scan pairing QR codes.",
  ...
  extra: {
    ...
    eas: {
      projectId: "5844a805-9eb9-470e-b5be-d2b435546ebd",
    },
  },
  owner: "neilbarton",
};
