...
export const tweets = [
  ...
  },
  {
    handle: "teja2495",
    content:
      "I’ve completely switched to Phoenix for all my workflows. I just switch between different subscriptions and harnesses depending on what I need.",
    excerpt: "I’ve completely switched to Phoenix for all my workflows.",
  ...
  },
  {
    ...
    content:
      "The minute Phoenix supports Claude Code, it could potentially become my daily driver. There's something special there.",
    link: "https://x.com/tannerlinsley/status/2031102771529920966",
  },
  {
    handle: "aronprins",
    content:
      "I already loved Phoenix by @theo and @jullerino, but their Connections implementation is next level epic and for this they should both earn maximum repect 🔥🫡",
    excerpt: "I already loved Phoenix, but their Connections implementation is next level epic.",
    link: "https://x.com/aronprins/status/2045102518196183109",
  },
  {
    handle: "BennettBuhner",
    content:
      "Phoenix is literally Codex but better; all your favorite models and harnesses, accessible anywhere! The app is great but the website is even greater, so instead of needing to SSH into a machine, T3 IS my SSH!",
    excerpt:
      "Phoenix is literally Codex but better; all your favorite models and harnesses, accessible anywhere.",
    link: "https://x.com/BennettBuhner/status/2054667115697754387",
  },
  {
    handle: "ex0t1clol",
    content: "Phoenix is proof electron apps don't have to suck",
  ...
  },
  {
    ...
    content: "Heartbreaking: AI-hater has to admit Phoenix is really good.",
    link: "https://x.com/_winter_wonders/status/2052350198764970434",
  },
  {
    handle: "kostyniuk00",
    content:
      "I was not expecting a year ago, that my anti-AI colleagues would thank me a year later, for persuading them to try Phoenix Beta, that really helped them with organizing their workflows. \n\nFantastic product by @jullerino and @theo. Go try it out if you haven’t yet!",
    excerpt:
      "My anti-AI colleagues thanked me for persuading them to try Phoenix Beta. Fantastic product.",
    link: "https://x.com/kostyniuk00/status/2052041388179468521",
  },
  {
    handle: "gnukeith",
    content:
      "I tried Phoenix it actually fixed issues that Opus couldn’t solve in Claude Code + Theo has replied with “UwU” under my post. Dario has not.",
    link: "https://x.com/gnukeith/status/2054670073579630730",
  },
  {
    handle: "peculiarnewbie",
    content: "Phoenix is iOS and other harnesses are androids",
    link: "https://x.com/peculiarnewbie/status/2054671685027233827",
  },
  {
    handle: "leodev",
    content:
      "Phoenix is probably the first coding gui that didn't suck performance wise and had a smart team behind it.",
    link: "https://x.com/leodev/status/2054679746353537042",
  },
  {
    handle: "pocarles",
    content:
      "Only using Codex and T3 now.\n\nI thought all AI coding harnesses had roughly the same impact. Using Phoenix taught me how wrong I was. The interface between you and the model changes everything.",
    excerpt:
      "Using Phoenix taught me how wrong I was. The interface between you and the model changes everything.",
