...
function aggregateRowForState(state: AgentActivityState) {
  return {
...
function terminalAggregateState(state: AgentActivityState): AgentActivityAggregateState {
...
function isRecentTerminalState(state: AgentActivityState, nowMs: number): boolean {
...
export function makeAggregateState(input: {
  readonly activeStates: ReadonlyArray<AgentActivityState>;
  readonly terminalState: AgentActivityState | null;
  readonly nowMs: number;
}): AgentActivityAggregateState | null {
...
export function activityPhasePriority(phase: AgentActivityState["phase"]): number {
