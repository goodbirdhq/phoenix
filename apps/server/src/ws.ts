  ...
  WsRpcGroup.toLayer(
    Effect.gen(function* () {
      ...
      const providerAvailabilityFor = (
        ...
        providerService.getAvailability === undefined
          ? Effect.succeed(ProviderService.unknownAvailabilityForDriver(provider))
          : providerService.getAvailability(instanceId, provider);
      ...
      const dispatchNormalizedCommand = (
        ...
        const dispatchEffect =
          normalizedCommand.type === "thread.turn.start" && normalizedCommand.bootstrap
            ? threadTurnBootstrap.bootstrapTurnStart(normalizedCommand, dispatchOptions)
          ...
          observeRpcEffect(
            ...
            Effect.gen(function* () {
              ...
              const archiveCommand =
                preparedCommand.type === "thread.archive" ? preparedCommand : undefined;
              ...
              const shouldStopSessionAfterCommand = archiveCommand
                ...
                : false;
              const result = yield* dispatchNormalizedCommand(preparedCommand).pipe(
        ...
        [WS_METHODS.subscribeProviderAvailability]: (input) =>
          observeRpcStreamEffect(
            ...
            Effect.gen(function* () {
              ...
              const subscription =
                providerService.subscribeAvailability === undefined
                  ? undefined
                  : yield* providerService.subscribeAvailability;
