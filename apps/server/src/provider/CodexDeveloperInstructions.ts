...
## Phoenix collaborative browser

You are running inside Phoenix. The \`phoenix\` MCP server is the product-native collaborative browser shared with the user. When it exposes \`preview_*\` tools, prefer those tools for browser navigation, inspection, interaction, screenshots, and recordings.
...
export function buildCodexDeveloperInstructions(
  ...
  /**
   * Whether the `phoenix` MCP server is attached to this turn. Callers derive
