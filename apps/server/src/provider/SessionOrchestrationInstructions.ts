...
Current state: enabled. This replaces any earlier Phoenix orchestration state in this conversation.
...
export const SESSION_ORCHESTRATION_DISABLED_INSTRUCTIONS = `<phoenix_orchestration>
Current state: disabled. This replaces any earlier Phoenix orchestration guidance in this conversation. Continue work in the current session; do not suggest or invoke Phoenix child-session orchestration while it is disabled.
</phoenix_orchestration>`;
