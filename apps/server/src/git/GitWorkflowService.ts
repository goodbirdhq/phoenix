...
export class GitWorkflowService extends Context.Service<
  GitWorkflowService,
  {
    ...
    readonly fetchPullRequestHeadCommit: (input: {
      readonly cwd: string;
...
export const make = Effect.gen(function* () {
  ...
  return GitWorkflowService.of({
    ...
    fetchPullRequestHeadCommit: (input) =>
      ensureGitCommand("GitWorkflowService.fetchPullRequestHeadCommit", input.cwd).pipe(
        Effect.andThen(git.fetchPullRequestHeadCommit(input)),
      ),
    fetchRemote: (input) =>
