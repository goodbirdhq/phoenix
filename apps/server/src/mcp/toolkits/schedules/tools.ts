...
const ListSchedulesTool = Tool.make("list_schedules", {
  description:
...
const GetScheduleTool = Tool.make("get_schedule", {
...
const CreateScheduleTool = Tool.make("create_schedule", {
  description:
...
const UpdateScheduleTool = Tool.make("update_schedule", {
  description:
...
const SetScheduleStateTool = Tool.make("set_schedule_state", {
  description:
...
const RunScheduleNowTool = Tool.make("run_schedule_now", {
  description:
