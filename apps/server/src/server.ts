...
const HostMetricsLayerLive = HostMetrics.layer.pipe(Layer.provide(ResourceTelemetryLayerLive));
...
const AuthLayerLive = Layer.merge(
  ...
  Layer.effectDiscard(retireManagedConnections),
).pipe(
