...
export const RPC_REQUIRED_SCOPES = {
  ...
  [SCHEDULE_WS_METHODS.dispatchCommand]: AuthOrchestrationOperateScope,
  [SCHEDULE_WS_METHODS.getSnapshot]: AuthOrchestrationReadScope,
  [SCHEDULE_WS_METHODS.getDetail]: AuthOrchestrationReadScope,
  [SCHEDULE_WS_METHODS.getHistory]: AuthOrchestrationReadScope,
  [SCHEDULE_WS_METHODS.subscribe]: AuthOrchestrationReadScope,
  ...
  [WS_METHODS.serverGetHostMetrics]: AuthOrchestrationReadScope,
  [WS_METHODS.serverGetHostMetricsHistory]: AuthOrchestrationReadScope,
  ...
  [WS_METHODS.subscribeProviderAvailability]: AuthOrchestrationReadScope,
