...
const OBJECT: &str = "/com/goodbird/Phoenix/KdeCapture/Feedback";
...
#[zbus::interface(name = "com.goodbird.Phoenix.KdeCapture.Feedback")]
impl Bridge {
...
mod tests {
    ...
    fn only_kwin_can_read_commands_or_acknowledge_feedback() {
        ...
        let unrelated = Proxy::new(
            ...
            destination.as_str(),
            OBJECT,
            "com.goodbird.Phoenix.KdeCapture.Feedback",
        )
        .unwrap();
