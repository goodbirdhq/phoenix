  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new Phoenix prerelease is available for nightly testers."
          : "A new Phoenix latest release is available.",
...
).pipe(Command.withDescription("Post a Phoenix release announcement to Discord."));
