...
# Invoked by ssh via SSH_ASKPASS when Phoenix re-runs ssh with a cached password
...
printf 'Phoenix ssh-askpass invoked without T3_SSH_AUTH_SECRET.\\n' >&2
exit 1
`;
...
export const ASKPASS_WINDOWS_SCRIPT = `# Invoked by ssh via SSH_ASKPASS (through ssh-askpass.cmd) when Phoenix re-runs\r
...
[Console]::Error.WriteLine("Phoenix ssh-askpass invoked without T3_SSH_AUTH_SECRET.")\r
exit 1\r
`;
