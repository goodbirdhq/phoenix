...
export function createThreadEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    migrate: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:migrate",
      execute: (input: MigrateThreadInput) => migrateThread(input),
      scheduler,
      concurrency,
    }),
