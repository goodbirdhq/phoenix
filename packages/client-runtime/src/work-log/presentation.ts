...
function workEntryIndicatesToolFailureFromOutput(
  ...
  // Partial streams can contain failure-looking output that a completed result later clears.
  // Keep the row neutral until the provider gives a terminal lifecycle state.
