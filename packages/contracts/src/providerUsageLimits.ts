 ...
 */
export const ProviderPlanKind = Schema.Literals(["subscription", "paygo", "enterprise", "unknown"]);
export type ProviderPlanKind = typeof ProviderPlanKind.Type;

export const ServerProviderUsageLimits = Schema.Struct({
  /** Native account evidence only; omitted by older servers means unknown. */
  planKind: Schema.optional(ProviderPlanKind),
