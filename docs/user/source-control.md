...
Phoenix integrates with GitHub, GitLab, Bitbucket, and Azure DevOps to clone and publish
repositories, create pull requests, and review changes.

## Connect an account

Install Git and configure authentication on the machine running your Phoenix server. For a remote
...
```bash
export PHOENIX_BITBUCKET_ACCESS_TOKEN="your-access-token"
```
...
```bash
export PHOENIX_BITBUCKET_EMAIL="you@example.com"
export PHOENIX_BITBUCKET_API_TOKEN="your-token"
```
...
Use a thread's Git actions to commit, push, and create a pull request. Phoenix can generate commit
