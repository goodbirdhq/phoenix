...
Device panel work over direct connections and Tailscale, including when an SSH host runs the devices.
...
npm-installed at a pinned version into the Phoenix home after its matching Device
